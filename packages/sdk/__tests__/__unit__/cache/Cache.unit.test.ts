...
describe("CMCI - Get Cache", () => {
  ...
  describe("success scenarios", () => {
    ...
    it("should be able to get a result cache", async () => {
      ...
      endPoint = CicsCmciConstants.SEPERATOR + CicsCmciConstants.CICS_SYSTEM_MANAGEMENT +
        CicsCmciConstants.SEPERATOR + CicsCmciConstants.CICS_RESULT_CACHE +
        CicsCmciConstants.SEPERATOR + cacheParms.cacheToken + "?" + CicsCmciConstants.NO_DISCARD;
    ...
    it("should be able to get a result cache with start index", async () => {
      ...
      endPoint = CicsCmciConstants.SEPERATOR + CicsCmciConstants.CICS_SYSTEM_MANAGEMENT +
        CicsCmciConstants.SEPERATOR + CicsCmciConstants.CICS_RESULT_CACHE +
        CicsCmciConstants.SEPERATOR + cacheParms.cacheToken + CicsCmciConstants.SEPERATOR +
    ...
    it("should be able to get a result cache without NODISCARD", async () => {
      ...
      endPoint = CicsCmciConstants.SEPERATOR + CicsCmciConstants.CICS_SYSTEM_MANAGEMENT +
        CicsCmciConstants.SEPERATOR + CicsCmciConstants.CICS_RESULT_CACHE +
        CicsCmciConstants.SEPERATOR + cacheParms.cacheToken;
